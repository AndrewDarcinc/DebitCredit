...
export default function OperationCalculator({ bill_id }) {
  ...
  const expense_income = useSelector((state) => state.counter.expenses_income);
            ...
            {isOperatorPressed ? (
              ...
              <SimpleButton
                ...
                onPress={() => {
                  ...
                  {
                    if (expense_income === "income") {
                      SqlQuery(
                        "insert into Operations (cost, bill_id, Incomes_Category_id) values(" +
                          stringBalance +
                          "," +
                          bill_id +
                          "," +
                      ...
                      SqlQuery(
                        "update Bills set amount = amount +" +
                          stringBalance +
                          " where bill_id = " +
                          bill_id +
                          ";"
                      );
                    } else if (expense_income == "expense") {
                      SqlQuery(
                        "insert into Operations (cost, bill_id, Expenses_Category_id) values(" +
                          stringBalance +
                          "," +
                          bill_id +
                          "," +
